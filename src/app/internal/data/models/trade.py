...
class Trade(models.Model):
    ...
    bid_id = models.ForeignKey(Order, on_delete=models.CASCADE, related_name='bids')
    ask_id = models.ForeignKey(Order, on_delete=models.CASCADE, related_name='asks')
    tool_id = models.ForeignKey(Tool, models.CASCADE)
